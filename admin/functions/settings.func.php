...
function add_modo($name,$email,$role,$token){
    ...
    $message = '
        <html lang="en" style="font-family: sans-serif;">
            ...
            <body>
                Voici votre identifiant et code unique à insérer sur <a href="http://kevindupas/admin/index.php?page=new">cette page</a>:
    ...
    $header .= 'From: dupas.dev@outlook.com' . "\r\n" . 'Reply-To: dupas.dev@outlook.com' . "\r\n" . 'X-Mailer: PHP/' . phpversion();
